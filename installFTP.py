...
class add_vitualuser(object):
    ...
    def __modifi_userconf(self):
        conf_content="cmds_allowed=ABOR,CWD,LIST,MDTM,DELE,MKD,NLST,PASS,PASV,PORT,PWD,QUIT,RETR,RMD,RNFR,RNTO,SIZE,STOR,TYPE,USER,ACCT,APPE,CDUP,HELP,MODE,NOOP,REIN,STAT,STOU,STRU,SYST,REST,FEAT\nfile_open_mode=0644\nanonymous_enable=NO\nwrite_enable=YES\nlocal_umask=022\nanon_upload_enable=YES\nanon_mkdir_write_enable=YES\nlocal_root="+self.__userdir
